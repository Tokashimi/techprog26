...
void RegisterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->registerRequested((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->switchToAuth(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterWidget::*)(const QString & , const QString & )>(_a, &RegisterWidget::registerRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (RegisterWidget::*)()>(_a, &RegisterWidget::switchToAuth, 1))
            return;
    }
}
...
// SIGNAL 0
void RegisterWidget::registerRequested(const QString & _t1, const QString & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void RegisterWidget::switchToAuth()
{

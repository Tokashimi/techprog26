...
void TaskWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->answerSubmitted((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TaskWidget::*)(const QString & )>(_a, &TaskWidget::answerSubmitted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TaskWidget::*)()>(_a, &TaskWidget::backToMenuRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void TaskWidget::answerSubmitted(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void TaskWidget::backToMenuRequested()
{
